...
@push('styles')
    <link rel="stylesheet" href="{{ asset('css/admin/book/create_book.css') }}" />
@endpush
                        ...
                        <div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="title" name="title"
                                    class="@error('title') error @enderror form-input" value="{{ old('title') }}" required
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="publisher" name="publisher"
                                    class="@error('publisher') error @enderror form-input" value="{{ old('publisher') }}"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="author" name="author"
                                    class="@error('author') error @enderror form-input" value="{{ old('author') }}" required
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="isbn" name="isbn"
                                    class="@error('isbn') error @enderror form-input" value="{{ old('isbn') }}"
                            ...
                            <div
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="category" name="category"
                                        ...
                                        <option value="Fiksi" {{ old('category') == 'Fiksi' ? 'selected' : '' }}>
                                            Fiksi
                                        </option>
                                        <option value="Non-Fiksi" {{ old('category') == 'Non-Fiksi' ? 'selected' : '' }}>
                                            Non-Fiksi
                                        </option>
                                        <option value="Novel" {{ old('category') == 'Novel' ? 'selected' : '' }}>
                                            Novel
                                        </option>
                                        <option value="Biografi" {{ old('category') == 'Biografi' ? 'selected' : '' }}>
                                            Biografi
                                        </option>
                                        <option value="Sejarah" {{ old('category') == 'Sejarah' ? 'selected' : '' }}>
                                            Sejarah
                                        </option>
                                        <option value="Sains" {{ old('category') == 'Sains' ? 'selected' : '' }}>
                                            Sains
                                        </option>
                                        ...
                                        <option value="Pendidikan"
                                            {{ old('category') == 'Pendidikan' ? 'selected' : '' }}>
                                            Pendidikan
                                        </option>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" id="stock" name="stock"
                                        class="@error('stock') error @enderror form-input" value="{{ old('stock', 1) }}"
                                        required min="0" placeholder="Jumlah buku" />
                                    @error('stock')
                                        <span class="form-error">
                                            <i class="bi bi-exclamation-circle"></i>
                                            {{ $message }}
