                ...
                <div class="filter-grid">
                    ...
                    <div>
                        ...
                        <select name="sort" class="filter-select">
                            ...
                            <option value="az" {{ isset($sort) && $sort === 'az' ? 'selected' : '' }}>Judul A → Z
                            </option>
                            <option value="za" {{ isset($sort) && $sort === 'za' ? 'selected' : '' }}>Judul Z → A
                            </option>
                            <option value="popular" {{ isset($sort) && $sort === 'popular' ? 'selected' : '' }}>Populer
                            </option>
                            <option value="newest" {{ isset($sort) && $sort === 'newest' ? 'selected' : '' }}>Terbaru
                            </option>
                            <option value="stock" {{ isset($sort) && $sort === 'stock' ? 'selected' : '' }}>Stok
                                Terbanyak</option>
                        </select>
                    </div>
                        ...
                        <tr>
                            <td colspan="6">
                                <div class="empty-state">
                                    ...
                                    <p style="font-size: 1.1rem; font-weight: 600; margin-bottom: 0.5rem;">Belum ada data
                                        buku</p>
