...
@section('content')
    <div class="container" style="padding-top: 2rem; padding-bottom: 2rem">
        ...
        <div class="stats-grid">
            <a href="{{ route('admin.loans.index', ['status' => 'pending']) }}" class="stat-mini-card"
            ...
            <a href="{{ route('admin.loans.index', ['status' => 'approved']) }}" class="stat-mini-card"
                style="text-decoration: none">
            ...
            <a href="{{ route('admin.loans.index', ['status' => 'returned']) }}" class="stat-mini-card"
                style="text-decoration: none">
