...
@section('content')
    <div class="container" style="padding-top: 2rem; padding-bottom: 2rem">
        ...
        <div class="page-header-section">
            <div class="page-header-content">
                ...
                <p class="page-header-subtitle">
                    Kelola dan verifikasi permintaan pengembalian buku
                </p>
            </div>
        </div>
        ...
        <div class="stats-grid">
            <a href="{{ route('admin.returns.index', ['status' => 'pending']) }}" class="stat-mini-card"
            ...
            <a href="{{ route('admin.returns.index', ['status' => 'approved']) }}" class="stat-mini-card"
                style="text-decoration: none">
            ...
            <a href="{{ route('admin.returns.index', ['late' => 1]) }}" class="stat-mini-card"
                style="text-decoration: none">
                            ...
                            <td colspan="5">
                                <div class="empty-state">
                                    ...
                                    <p style="font-size: 0.9rem">
                                        Permintaan pengembalian buku akan muncul di sini
                                    </p>
                                </div>
                            </td>
                        </tr>
    ...
    <div class="modal" id="approveModal">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p class="modal-text">
                    Approve the return of the book
                    <strong id="approveBookTitle"></strong>
                    from member
                    <strong id="approveMemberName"></strong>
                    ?
                    <br />
                    <br />
                    The book will be returned to library stock.
                </p>
    ...
    <div class="modal" id="rejectModal">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p class="modal-text">
                    Reject the return of the book
                    <strong id="rejectBookTitle"></strong>
                    from member
                    <strong id="rejectMemberName"></strong>
                    ?
                    <br />
                    <br />
