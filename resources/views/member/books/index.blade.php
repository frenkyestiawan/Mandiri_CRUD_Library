                ...
                <div class="filter-grid">
                    ...
                    <div>
                        ...
                        <select name="sort" class="filter-select">
                            ...
                            <option value="az" {{ isset($sort) && $sort === 'az' ? 'selected' : '' }}>
                                Judul A → Z
                            </option>
                            <option value="za" {{ isset($sort) && $sort === 'za' ? 'selected' : '' }}>
                                Judul Z → A
                            </option>
                            <option value="popular" {{ isset($sort) && $sort === 'popular' ? 'selected' : '' }}>
                                Populer
                            </option>
                            <option value="newest" {{ isset($sort) && $sort === 'newest' ? 'selected' : '' }}>
                                Terbaru
                            </option>
                            <option value="stock" {{ isset($sort) && $sort === 'stock' ? 'selected' : '' }}>
                                Stok Terbanyak
                            </option>
                        </select>
                    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p class="modal-text">
                    ...
                    <strong id="borrowBookTitle"></strong>
                    ?
                    <br />
                    <br />
